...
const CreateListing = () => {
  // UPLOAD , DRAG AND DROP AWA REMOVE PHOTOS
      ...
      <div className="create-listing">
        ...
        <form onSubmit={handlePost}>
          <div className="create-listing_step1">
            ...
            <hr />
            <h3> Which of these categories best desrribe u place </h3>
            ...
            <div className="half">
              ...
              <div className="location">
                <p>City</p>
                <input type="text" placeholder="City" name="city" required value={formLocation.city}                   onChange={handleChangeLocation}
 />
              </div>
            </div>
            {/* >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> */}
          ...
          <div className="create-listing_step2">
            <h2>Step:2 Make ur place stand out</h2>
            <hr />
